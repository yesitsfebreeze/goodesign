...
**Read when:** anything feels cramped, floaty, or "off" and you cannot say why.
Decided first, before type, before everything.

Space is the primary material. Everything else follows from it.

- **You do not add whitespace.** You remove what is not the thing. What remains
  is space, and it is the design.
- **Proximity is the first grouping tool** — before a line, a box, a tint or a
  card. A border between two blocks is an admission that the spacing failed.
...
- **Empty may stay empty.** The urge to fill the right third is the urge to ruin
  it. Space is not unused; it is the thing doing the work.

## The squint test

Blur the screen until text is unreadable. The hierarchy should still be visible
as blocks of value and weight. If it is not, no amount of type or colour will
save it.
